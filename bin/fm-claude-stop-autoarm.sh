...
#   - Need: arms only while the shared predicate in bin/fm-supervision-lib.sh
#     reports supervision need - work in flight (state/*.meta) or an
#     external-channel poll to run; an idle home exits 0.
