...
| `fm-cipher-hook.sh`      | Deliver authenticated decision and iinvy exact-head events, retry transiently held deliveries after gateway recovery, and expose Cipher's guarded merge entrypoint |
