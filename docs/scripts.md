...
| `fm-decision-nudge.sh`   | Claude Code hook sending one content-free Telegram nudge when a primary decision prompt waits unanswered (docs/configuration.md "Captain-attention nudge") |
