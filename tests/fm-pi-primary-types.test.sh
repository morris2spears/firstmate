...
cp "$ROOT/.pi/extensions/fm-primary-decision-nudge.ts" "$TMP_ROOT/fm-primary-decision-nudge.ts"
...
cp "$ROOT/.pi/extensions/lib/fm-calm-nonconversation-layout.ts" "$TMP_ROOT/lib/fm-calm-nonconversation-layout.ts"
cp "$ROOT/.pi/extensions/lib/fm-calm-operational-user-layout.ts" "$TMP_ROOT/lib/fm-calm-operational-user-layout.ts"
cp "$ROOT/.pi/extensions/lib/fm-calm-tool-layout.ts" "$TMP_ROOT/lib/fm-calm-tool-layout.ts"
...
cp "$ROOT/.pi/extensions/lib/fm-primary-loaded-marker.ts" "$TMP_ROOT/lib/fm-primary-loaded-marker.ts"
